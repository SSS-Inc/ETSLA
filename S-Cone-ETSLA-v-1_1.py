...
if profile == 'ets':
    ...
    ssh.exec_command("uci set firewall.@redirect[0].dest_port='22'")
    ssh.exec_command("uci set firewall.@redirect[0].dest_ip='192.168.1.1'")
    ssh.exec_command("uci set firewall.@redirect[0].name='CCXA_ssh'")
    ...
    ssh.exec_command("uci set firewall.@redirect[1].dest_port='4803'")
    ssh.exec_command("uci set firewall.@redirect[1].name='CCXA_spread'")
    ssh.exec_command("uci set firewall.@redirect[1].dest_ip='192.168.1.1'")
    ssh.exec_command("uci set firewall.@redirect[1].target='DNAT'")
    ...
    ssh.exec_command("uci set firewall.@redirect[2].dest='lan'")
    ssh.exec_command("uci set firewall.@redirect[2].proto='tcp'")
    ssh.exec_command("uci set firewall.@redirect[2].src_dport='8099'")
    ssh.exec_command("uci set firewall.@redirect[2].dest_ip='192.168.1.99'")
    ssh.exec_command("uci set firewall.@redirect[2].dest_port='22'")
    ssh.exec_command("uci set firewall.@redirect[2].name='GPS_ssh'")
    ...
    ssh.exec_command("uci set firewall.@redirect[4].src_dport='7777'")
    ssh.exec_command("uci set firewall.@redirect[4].dest_ip='192.168.1.99'")
    ssh.exec_command("uci set firewall.@redirect[4].dest_port='7777'")
    ssh.exec_command("uci set firewall.@redirect[4].name='GPS_map'")
    ...
    ssh.exec_command("uci set firewall.@redirect[6].src_dport='8080'")
    ssh.exec_command("uci set firewall.@redirect[6].dest_ip='192.168.1.99'")
    ssh.exec_command("uci set firewall.@redirect[6].dest_port='80'")
    ssh.exec_command("uci set firewall.@redirect[6].name='GPS_html'")
    ...
    ssh.exec_command("uci set firewall.@redirect[7].dest_ip='192.168.1.2'")
    ssh.exec_command("uci set firewall.@redirect[7].src_dport='5900'")
    ssh.exec_command("uci set firewall.@redirect[7].name='GPS_rtcm-correction'")
    ssh.exec_command("uci set firewall.@redirect[7].dest_port='5900'")
    ...
    ssh.exec_command("uci set firewall.@redirect[8].src_dport='8081'")
    ssh.exec_command("uci set firewall.@redirect[8].dest_ip='192.168.1.1'")
    ssh.exec_command("uci set firewall.@redirect[8].dest_port='80'")
    ssh.exec_command("uci set firewall.@redirect[8].name='CCXA_html'")
    ...
    ssh.exec_command("uci set firewall.@redirect[9].proto='tcp'")
    ssh.exec_command("uci set firewall.@redirect[9].src_dport='8082'")
    ssh.exec_command("uci set firewall.@redirect[9].dest_ip='192.168.1.100'")
    ssh.exec_command("uci set firewall.@redirect[9].dest_port='80'")
    ssh.exec_command("uci set firewall.@redirect[9].name='GPS_html'")
